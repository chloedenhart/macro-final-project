...
```
**Interpretation**
This graph represents the sales in thousands of dollars versus the federal funds rate from 2020-2024. It shows a dip in the fed funds rate when the Covid pandemic hit to create a uptick in consumer confidence despite many people being unemployed and not feeling confident in the economy. Around this time we see a massive decrease in the amount of clothing sales. As soon as the fed rate was decreased the number of clothing sales quickly increases. From then on we see a constant trend of an increase and decrease of sales which appears to be due to trends in the clothing industry or seasonal effects. 
...
```
**Interpretation**
This correlation matrix shows us the relationship between several factors within the rates and the clothing retail sector. Fed funbds versus clothing sales shows us a 
